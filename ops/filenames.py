...
FILE_PATTERN = [
        ...
        r'([_-](?P<channel_1>((DAPI-GFP)|(DAPI)|(GFP)|(CY3)|(A594)|(CY5)|(CY7)|(AF750)|(mCherry)))(_(1x1)|([0-9]+p))?)?',
        r'([_-](?P<channel_2>((DAPI-GFP)|(DAPI)|(GFP)|(CY3)|(A594)|(CY5)|(CY7)|(AF750)|(mCherry)))(_(1x1)|([0-9]+p))?)?',
        r'([_-](?P<channel_3>((DAPI-GFP)|(DAPI)|(GFP)|(CY3)|(A594)|(CY5)|(CY7)|(AF750)|(mCherry)))(_(1x1)|([0-9]+p))?)?',
        r'([_-](?P<channel_4>((DAPI-GFP)|(DAPI)|(GFP)|(CY3)|(A594)|(CY5)|(CY7)|(AF750)|(mCherry)))(_(1x1)|([0-9]+p))?)?',
        r'([_-](?P<channel_5>((DAPI-GFP)|(DAPI)|(GFP)|(CY3)|(A594)|(CY5)|(CY7)|(AF750)|(mCherry)))(_(1x1)|([0-9]+p))?)?',
        r'([_-](?P<channel_6>((DAPI-GFP)|(DAPI)|(GFP)|(CY3)|(A594)|(CY5)|(CY7)|(AF750)|(mCherry)))(_(1x1)|([0-9]+p))?)*?',
